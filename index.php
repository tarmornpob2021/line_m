...
<div class="container">
  ...
  <tbody>
    ...
    <tr id="<?=$i;?>">
      ...
      <th scope="row"><input type="text" id="group_n<?=$i;?>" class="form-control" placeholder="Group Line" value="<?= $array_des[$i]["group_n"]; ?>" requried></th>

      <td><input type="text" id="token_n<?=$i;?>" class="form-control" placeholder="Token " value="<?= $array_des[$i]["token"]; ?>" required></td>
...
<input type="hidden" id="id_pry<?=$i;?>" class="form-control" placeholder="Token " value="<?= $array_des[$i]["id"]; ?>">
  ...
  <?php }  ?>
  <tr id="<?=$row_c;?>">
      <th scope="row"><input type="text" id="group_n<?= $row_c; ?>" class="form-control" placeholder="Group Line"></th>
      <td><input type="text" id="token_n<?= $row_c; ?>" class="form-control" placeholder="Token "></td>
      <td><input type="text" id="email<?= $row_c; ?>" class="form-control" placeholder="E Mail"   onkeyup="myFunction(event,this.id)" ></td>
      <input type="hidden" id="id_pry<?=$row_c;?>" class="form-control" placeholder="Token " value="<?= $row_c+1; ?>">

    </tr>
  </tbody>
</table>

<input type="hidden" id="last_c" class="form-control" value="<?= $row_c+1; ?>">
...
var int_re = value - 2;
var zxzx = parseInt($("#last_c").val()) - 1;
 ...
 var item_load = item_load + '<input type="hidden" id="id_pry' + (int_re + 1) + '" value="' + (int_re + 2) + '" class="form-control" placeholder="Token">';
...
var item_load = item_load + '</tr>';
  ...
  var btnremove = '<td><button class="btn btn-danger" value="' + (int_re + 1) + '" onclick="Delete(this.value);"><i class="fas fa-trash"></i></button></td>';
